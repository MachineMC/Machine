...
public enum BlockEntityBase {
    ...
    SIGN(Material.OAK_SIGN, Material.SPRUCE_SIGN, Material.BIRCH_SIGN, Material.ACACIA_SIGN, Material.CHERRY_SIGN,
            Material.JUNGLE_SIGN, Material.DARK_OAK_SIGN, Material.OAK_WALL_SIGN, Material.SPRUCE_WALL_SIGN,
            Material.BIRCH_WALL_SIGN, Material.ACACIA_WALL_SIGN, Material.CHERRY_WALL_SIGN, Material.JUNGLE_WALL_SIGN,
            Material.DARK_OAK_WALL_SIGN, Material.CRIMSON_SIGN, Material.CRIMSON_WALL_SIGN, Material.WARPED_SIGN,
            Material.WARPED_WALL_SIGN, Material.MANGROVE_SIGN, Material.MANGROVE_WALL_SIGN, Material.BAMBOO_SIGN,
            Material.BAMBOO_WALL_SIGN),
    HANGING_SIGN(Material.OAK_HANGING_SIGN, Material.SPRUCE_HANGING_SIGN, Material.BIRCH_HANGING_SIGN,
            Material.ACACIA_HANGING_SIGN, Material.CHERRY_HANGING_SIGN, Material.JUNGLE_HANGING_SIGN,
            Material.DARK_OAK_HANGING_SIGN, Material.CRIMSON_HANGING_SIGN, Material.WARPED_HANGING_SIGN,
            Material.MANGROVE_HANGING_SIGN, Material.BAMBOO_HANGING_SIGN, Material.OAK_WALL_HANGING_SIGN,
            Material.SPRUCE_WALL_HANGING_SIGN, Material.BIRCH_WALL_HANGING_SIGN, Material.ACACIA_WALL_HANGING_SIGN,
            Material.CHERRY_WALL_HANGING_SIGN, Material.JUNGLE_WALL_HANGING_SIGN, Material.DARK_OAK_WALL_HANGING_SIGN,
            Material.CRIMSON_WALL_HANGING_SIGN, Material.WARPED_WALL_HANGING_SIGN, Material.MANGROVE_WALL_HANGING_SIGN,
    ...
    SKULL(Material.SKELETON_SKULL, Material.SKELETON_WALL_SKULL, Material.CREEPER_HEAD, Material.CREEPER_WALL_HEAD,
            Material.DRAGON_HEAD, Material.DRAGON_WALL_HEAD, Material.ZOMBIE_HEAD, Material.ZOMBIE_WALL_HEAD,
            Material.WITHER_SKELETON_SKULL, Material.WITHER_SKELETON_WALL_SKULL, Material.PLAYER_HEAD,
            Material.PLAYER_WALL_HEAD, Material.PIGLIN_HEAD, Material.PIGLIN_WALL_HEAD),
    ...
    CALIBRATED_SCULK_SENSOR(Material.CALIBRATED_SCULK_SENSOR),
    SCULK_CATALYST(Material.SCULK_CATALYST),
    SCULK_SHRIEKER(Material.SCULK_SHRIEKER),
    CHISELED_BOOKSHELF(Material.CHISELED_BOOKSHELF),
    BRUSHABLE_BLOCK(Material.SUSPICIOUS_SAND, Material.SUSPICIOUS_GRAVEL),
    DECORATED_POT(Material.DECORATED_POT);
