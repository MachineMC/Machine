...
public enum ParticleType {
    ...
    AMBIENT_ENTITY_EFFECT(NamespacedKey.minecraft("ambient_entity_effect"), 0),
    ANGRY_VILLAGER(NamespacedKey.minecraft("angry_villager"), 1),
    BLOCK(NamespacedKey.minecraft("block"), 2);
