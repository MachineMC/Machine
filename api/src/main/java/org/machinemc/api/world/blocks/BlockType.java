...
public interface BlockType {
     ...
     */
    @Contract("_ -> new")
    BlockVisual getVisual(@Nullable WorldBlock.Snapshot block);
     ...
     */
    @NotNull WorldBlock.Snapshot init(World world, BlockPosition position);

    /**
     * Called when a new world block of this block type is created.
     * @param block created world block
     */
    void place(WorldBlock.Snapshot block); // TODO Event argument as source of the creation

    /**
     * Called when a world block of this block type is removed.
     * @param block removed world block
     */
    void destroy(WorldBlock.Snapshot block); // TODO Event argument as source of the destruction

    /**
     * Called when a world block of this type is updated.
     * @param block updated world block
     */
    void update(WorldBlock.Snapshot block); // TODO Event argument as source of the update
