 ...
 */
package org.machinemc.network.protocol.handshake;
...
/**
 * Packet listener for handshake packets.
 */
public interface HandshakePacketListener extends PacketListener {

    /**
     * Called when initial handshake packet is received.
     *
     * @param packet packet
     */
    void onClientIntention(C2SClientIntentionPacket packet);
